<div class="ui fixed blue inverted menu">
    <a href="<?php echo base_url();?>/dashboard.php'; ?>" class="header item" STYLE="letter-spacing: 3px">
    ...
    <div class="right menu">
        ...
        <div class="ui pointing dropdown item" tabindex="0">
            <img class="ui avatar image" src="<?php echo base_url();?>assets/img/avatar04.png?>"> <span><?php  echo $this->session->userdata('nama_lengkap'); ?></span> <i class="dropdown icon"></i>
            <div class="menu transition hidden" tabindex="-1">
