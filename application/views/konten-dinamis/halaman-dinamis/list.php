            ...
            <div class="ui segment">
              <form class="ui filter form">
                <div class="inline fields">
                  ...
                  <div class="field">
                    <select name="filter[status]" class="ui dropdown selection">
              ...
              <table class="ui celled table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="center aligned">dolorum-atque-ipsam-quidem-deserunt</td>
                    <td class="center aligned">Ad animi eos deleniti doloribus sit, beatae aperiam assumenda, minus id autem quia.</td>
