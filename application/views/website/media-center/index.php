            ...
            <div class="ui segment">
              <form class="ui filter form">
                <div class="inline fields">
                  <div class="field">
                    <input name="filter[judul]" id="filter_nama_media_center" placeholder="Judul" type="text">
                  </div>
                  <div class="field">
                    <input name="filter[deskripsi]" id="filter_deskripsi" placeholder="Deskripsi" type="text">
                  </div>
                  <div class="field">
                  ...
                  <button type="reset" class="ui icon reset button" id="btn_reset" data-content="Bersihkan Pencarian">
