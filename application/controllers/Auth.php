...
class Auth extends CI_Controller {
 ...
 function login()
 {
  $data['title_page']='RS Harapan Kita | Log in';
  ...
  {
    $this->template->login('mlogin_view',$data);
  }else{
    $this->template->login('login_view',$data);
  }
...
function get_validation()
{
  ...
  $this->session->set_flashdata('message_login', 'Email / Password Salah.');
